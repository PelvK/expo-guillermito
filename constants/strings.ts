...
export const BACKGROUND_OPACITY: number = 0.7;
export const FOOTER_DRAWER_TEXT : string = "Desarrollado por EFIHumboldt";
export const TEAM_NOT_FOUND_TEXT : string = "Equipo no encontrado";
export const CATEGORY_NOT_FOUND_TEXT : string = "Categoría no encontrada";